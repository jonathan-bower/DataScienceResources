...
###Scripting Languages:
As I use predominantly python - I will keep this as the language of choice for other libraries. I enjoy using python as it has more applicability to work with other environments and problems aside from data analysis and it has many useful libraries.  This isn't to say that R doesn't have it's place but rather since I use Python as my go to language, this site will be focused on Python related libraries.  Other languages not covered: Julia, R, Cython, Pig, Scala, Java, etc.
...
####Python Stats/Engineering Libraries
...
![alt text](http://a.fastcompany.net/multisite_files/fastcompany/imagecache/inline-large/inline/2013/07/3008621-inline-3008621-inline-skills-datascientists.png = 100x100)  
[Data Science For Startups](http://tomtunguz.com/data-science-types/) Which of the Five Types of DS does your startup need?  Different classification.
