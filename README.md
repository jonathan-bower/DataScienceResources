...
I aim to include topics of data science that aren't either actively covered or overly talked about.  This site is not unique in its goal and gladly points anyone to some of the other open source Data Science resources (linked below).

Personally, I acquired my skills through programming in an on-the-job environment and then taking three months off to learn and put into practice my data science skills @ Zipfian Academy.  For me taking that time off to learn, run the daily/weekly sprints, and be in a collective learning environment was irreplaceable.  Even if Zipfian resources were open source (which they aren't) taking the time off work and having the drive to push through all that material would be next to impossible. 
...
###Data Acquisition:
Some libraries that are very helpful for abstracting away some of the complications of scraping or working with HTTP.  
...
###Machine Learning:
There is a lot of information on the internet about the theory, mathematical intuition, tuning, etc for this discipline.  I am not trying to cover it in that depth, at least not at this current time.  These are just some high level toolkits to work with.  
...
####Feature Engineering:
A critical element of Data Science but minimally talked about. 
[Ipyhon Notebook for Feature engineering](http://nbviewer.ipython.org/urls/raw2.github.com/yhat/DataGotham2013/master/notebooks/7%20-%20Feature%20Engineering.ipynb?create=1) - Some discussion about Feature Engineering
...
[Multitreading and Queues](http://pymotw.com/2/Queue/) - How to build multithreading and queues.   
